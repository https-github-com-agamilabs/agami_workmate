...
<head>
	...
	<link rel="stylesheet" href="<?= $publicAccessUrl ?>/themes/va/css/animate.css">
	<link rel="stylesheet" href="<?= $publicAccessUrl ?>/themes/va/css/owl.carousel.min.css">
	<link rel="stylesheet" href="<?= $publicAccessUrl ?>/themes/va/css/owl.theme.default.min.css">
	<link rel="stylesheet" href="<?= $publicAccessUrl ?>/themes/va/css/magnific-popup.css">
	<link rel="stylesheet" href="<?= $publicAccessUrl ?>/themes/va/css/flaticon.css">
	<link rel="stylesheet" href="<?= $publicAccessUrl ?>/themes/va/css/style.css">
</head>

<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html">Virtual Assistant</a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="pricing.html" class="nav-link">Pricing Plans</a></li>
	...
	<!-- END nav -->
	<div class="hero-wrap" style="background-image: url('<?= $publicAccessUrl ?>/themes/va/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
			...
			<div class="row no-gutters slider-text align-items-center">
				<div class="col-md-7 ftco-animate d-flex align-items-end">
					<div class="text w-100">
						<h1 class="mb-4">Save Your Precious Time &amp; Outsource Daily Tasks</h1>
						<p class="mb-4">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
						<p><a href="#" class="btn btn-primary py-3 px-4">Request Our Assistant</a></p>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="ftco-section ftco-fullwidth goto-here">
		...
		<div class="container-fluid px-0">
			<div class="row d-sm-flex text-wrapper align-items-stretch">
				<div class="one-half mb-md-0 mb-4 img d-flex align-self-stretch" style="background-image: url('<?= $publicAccessUrl ?>/themes/va/images/about.jpg');"></div>
	...
	<section class="ftco-section ftco-no-pb ftco-no-pt">
		<div class="container">
			<div class="row">
				<div class="col-md-6 img img-3 d-flex justify-content-center align-items-center" style="background-image: url(<?= $publicAccessUrl ?>/themes/va/images/about-1.jpg);">
				</div>
							...
							<div class="testimony-wrap py-4">
								...
								<div class="text">
									...
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(<?= $publicAccessUrl ?>/themes/va/images/person_1.jpg)"></div>
										<div class="pl-3">
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								...
								<div class="text">
									<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(<?= $publicAccessUrl ?>/themes/va/images/person_2.jpg)"></div>
										<div class="pl-3">
											<p class="name">Roger Scott</p>
											<span class="position">Marketing Manager</span>
										</div>
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								...
								<div class="text">
									<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(<?= $publicAccessUrl ?>/themes/va/images/person_3.jpg)"></div>
										<div class="pl-3">
											<p class="name">Roger Scott</p>
											<span class="position">Marketing Manager</span>
										</div>
			...
			<div class="row d-flex">
				<div class="col-md-3 d-flex ftco-animate">
					<div class="blog-entry justify-content-end">
						<div class="text">
							<a href="blog-single.html" class="block-20 img" style="background-image: url('<?= $publicAccessUrl ?>/themes/va/images/image_1.jpg');">
							</a>
							<div class="meta mb-1">
				...
				<div class="col-md-3 d-flex ftco-animate">
					<div class="blog-entry justify-content-end">
						<div class="text">
							<a href="blog-single.html" class="block-20 img" style="background-image: url('<?= $publicAccessUrl ?>/themes/va/images/image_2.jpg');">
							</a>
							<div class="meta mb-1">
								<div><a href="#">April 12, 2020</a></div>
								<div><a href="#">Admin</a></div>
				...
				<div class="col-md-3 d-flex ftco-animate">
					<div class="blog-entry justify-content-end">
						<div class="text">
							<a href="blog-single.html" class="block-20 img" style="background-image: url('<?= $publicAccessUrl ?>/themes/va/images/image_3.jpg');">
							</a>
							<div class="meta mb-1">
								<div><a href="#">April 12, 2020</a></div>
								<div><a href="#">Admin</a></div>
				...
				<div class="col-md-3 d-flex ftco-animate">
					<div class="blog-entry justify-content-end">
						<div class="text">
							<a href="blog-single.html" class="block-20 img" style="background-image: url('<?= $publicAccessUrl ?>/themes/va/images/image_4.jpg');">
							</a>
							<div class="meta mb-1">
								<div><a href="#">April 12, 2020</a></div>
								<div><a href="#">Admin</a></div>
	...
	<section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb img" style="background-image: url(<?= $publicAccessUrl ?>/themes/va/images/bg_2.jpg);">
		<div class="overlay"></div>
		<div class="container">
								...
								<div class="form-group">
									<div class="form-field">
										<div class="select-wrap">
											...
											<select name="va_purpose" id="va_purpose" class="form-control">
			...
			<div class="row mb-5">
				<div class="col-sm-12 col-md">
					<div class="ftco-footer-widget mb-4">
						<h2 class="ftco-heading-2 logo"><a href="#">Virtual Assistant</a></h2>
	...
	<script src="<?= $publicAccessUrl ?>/themes/va/js/jquery.min.js"></script>
	<script src="<?= $publicAccessUrl ?>/themes/va/js/jquery-migrate-3.0.1.min.js"></script>
	<script src="<?= $publicAccessUrl ?>/themes/va/js/popper.min.js"></script>
	<script src="<?= $publicAccessUrl ?>/themes/va/js/bootstrap.min.js"></script>
	<script src="<?= $publicAccessUrl ?>/themes/va/js/jquery.easing.1.3.js"></script>
	<script src="<?= $publicAccessUrl ?>/themes/va/js/jquery.waypoints.min.js"></script>
	<script src="<?= $publicAccessUrl ?>/themes/va/js/jquery.stellar.min.js"></script>
	<script src="<?= $publicAccessUrl ?>/themes/va/js/owl.carousel.min.js"></script>
	<script src="<?= $publicAccessUrl ?>/themes/va/js/jquery.magnific-popup.min.js"></script>
	<script src="<?= $publicAccessUrl ?>/themes/va/js/jquery.animateNumber.min.js"></script>
	<script src="<?= $publicAccessUrl ?>/themes/va/js/scrollax.min.js"></script>
	<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script> -->
	<script src="<?= $publicAccessUrl ?>/themes/va/js/google-map.js"></script>
	<script src="<?= $publicAccessUrl ?>/themes/va/js/main.js"></script>
</body>
