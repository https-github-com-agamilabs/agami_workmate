...
$arrayData = array_merge($arrayData, langConverter($lang, 'about'));
//print_r($arrayData);
...
if (!defined("DB_USER")) {
    include_once $basePath . '/php/admin/db/config.php';
} else {
}
?>
...
<body>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title"> <?= $arrayData['lang_about_us']; ?> </h3>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="features-content">
                        <h2><?= $arrayData['lang_we_always_put_our_pacients_first']; ?></h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-4">
                    <div class="video-content">
                        <h2><?= $arrayData['lang_a_day_at_medilife-video']; ?></h2>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Lorem ipsum dolor sit amet, consectetuer adipiscing eli. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-3 col-lg-2">
                    <div class="single-pie-bar" data-percent="90">
                        ...
                        <h5><?= $arrayData['lang_donations']; ?></h5>
                        <p>Dolor sit amet</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3 col-lg-2">
                ...
                <div class="col-12 col-sm-6 col-md-3 col-lg-2">
                    <div class="single-pie-bar" data-percent="25">
                        <canvas class="bar-circle" width="100" height="100"></canvas>
                        <h5><?= $arrayData['lang_good_luck']; ?></h5>
                        <p>Dolor sit amet</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3 col-lg-2">
                    <div class="single-pie-bar" data-percent="69">
                        <canvas class="bar-circle" width="100" height="100"></canvas>
                        <h5><?= $arrayData['lang_high_tech']; ?></h5>
                        <p>Dolor sit amet</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3 col-lg-2">
                ...
                <div class="col-12 col-sm-6 col-md-3 col-lg-2">
                    <div class="single-pie-bar" data-percent="38">
                        <canvas class="bar-circle" width="100" height="100"></canvas>
                        <h5><?= $arrayData['lang_creativity']; ?></h5>
                        <p>Dolor sit amet</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="medilife-tabs-content">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="institution-tab" data-toggle="tab" href="#institution" role="tab" aria-controls="institution" aria-selected="false"><?= $arrayData['lang_institution']; ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="faq-tab" data-toggle="tab" href="#faq" role="tab" aria-controls="faq" aria-selected="false"><?= $arrayData['lang_faq']; ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" id="specialities-tab" data-toggle="tab" href="#specialities" role="tab" aria-controls="specialities" aria-selected="true"><?= $arrayData['lang_specialities']; ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="laboratory-tab" data-toggle="tab" href="#laboratory" role="tab" aria-controls="laboratory" aria-selected="false"><?= $arrayData['lang_laboratory']; ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="emergencies-tab" data-toggle="tab" href="#emergencies" role="tab" aria-controls="emergencies" aria-selected="false"><?= $arrayData['lang_emergencies']; ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="scolarship-tab" data-toggle="tab" href="#scolarship" role="tab" aria-controls="scolarship" aria-selected="false"><?= $arrayData['lang_scolarship_programs']; ?></a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade" id="institution" role="tabpanel" aria-labelledby="institution-tab">
                                <div class="medilife-tab-content d-md-flex align-items-center">
                                    ...
                                    <div class="medilife-tab-text">
                                        <h2><?= $arrayData['lang_take_a_look_at_this']; ?></h2>
    ...
    <!-- Active js -->
    <script src="<?= $publicAccessUrl ?>themes/smart/js/active.js"></script>
