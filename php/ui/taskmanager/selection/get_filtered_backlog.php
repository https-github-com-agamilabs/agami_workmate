<?php
    ...
    try {
        ...
        $results = get_filtered_backlog($dbcon,$channelno, $assignedto, $startdate,$enddate,$wstatusno,$pageno,$limit,$userno);
        $results_array = array();
    ...
    */
    ...
    function get_filtered_backlog($dbcon,$channelno,$assignedto,$startdate,$enddate,$wstatusno,$pageno,$limit,$login_userno){
        ...
        $channel_filter=" ";
        if($channelno>0){
            $channel_filter = " channelno =  $channelno";
        }else{
            $channel_filter = " 1 ";
        }
