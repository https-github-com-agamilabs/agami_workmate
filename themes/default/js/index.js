    ...
    $.each(data, (index, value) => {
        let column = $(`<div class="col-md-6">
                            <div class="card shadow-3-strong mb-3">
								<div class="card-body">
									<h6 class="text-primary mb-0" style="text-transform: none;">${value.title || ``
            }</h6>
...
function show_gallery(data) {
    ...
    $.each(data, (index, value) => {
        let item = $(`<div class="${value.catno == 1 ? `` : `single-gallery-item`}">
                        ${value.catno == 2
                ? `<img src="${value.thumbnailimageurl || value.imageurl || ``
...
function show_hero_carousel_data(data) {
    ...
    $.each(data, (index, value) => {
        let slide =
            $(`<div class="single-hero-slide bg-img bg-overlay-white" style="background-image: url(${value.imageurl || ``
                });">
                        <div class="container h-100">
                            <div class="row h-100 align-items-center">
                                <div class="col-12">
                                    <div class="hero-slides-content">
                                        <h2 data-animation="fadeInUp" data-delay="100ms">${value.title || ``
                }</h2>
                                        <h3 data-animation="fadeInUp" data-delay="200ms">${value[`sub-title`] || ``
                }</h3>
                                        <h6 data-animation="fadeInUp" data-delay="400ms">${value[`subsub-title`] || ``
                }</h6>
                                        <a href="#" class="btn medilife-btn mt-50" data-animation="fadeInUp" data-delay="700ms">${value[`extra-button`] || ``
                }</a>
                                    </div>
                                </div>
                            </div>
        ...
        let column = $(`<div class="col-sm-6">
                <div class="single-service-area d-flex">
                    <div class="service-icon">
                        <i class="${value.icon || `fas fa-user-tie`}"></i>
                    </div>
...
const doctorSelect2Settings = {
    ...
    templateResult: (value) => {
        ...
        return $(`<div class="">
                            <div class="font-weight-bold">${value.firstname} ${value.lastname || ``
            }</div>
    ...
    $.each(data, (index, value) => {
        ...
        let template =
            $(`<div class="custom-radio custom-control custom-control-inline">
							<input id="chamber_${value.chamberno
                }_radio" type="radio" name="chamberno" value="${value.chamberno
